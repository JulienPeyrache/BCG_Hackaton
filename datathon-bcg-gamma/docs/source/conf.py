...
# datathon_bcg_gamma documentation build
...
from datathon_bcg_gamma import __version__ as release

# -- Project information -----------------------------------------------------

project = "datathon_bcg_gamma"
author = "Kedro"
...
htmlhelp_basename = "datathon_bcg_gammadoc"
...
latex_documents = [
    (
        master_doc,
        "datathon_bcg_gamma.tex",
        "datathon_bcg_gamma Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "datathon_bcg_gamma",
        "Project datathon_bcg_gamma codebase.",
        "Data-Science",
    )
]
